...
class Movie extends Component {
  ...
  toggleFavourite() {
    ...
    this.setState({ favourite: !this.state.favourite }, function() {
      if (this.state.favourite) {
        ...
        M.toast({
          html: `<a href="/wishlist">${movie.title} has been favourited.</a>`,
          classes: "fav",
          displayLength: 2000
        });
      } else {
        ...
        M.toast({
          html: `<a href="/wishlist">${movie.title} has been unfavourited.</a>`,
          classes: "fav",
          displayLength: 2000
        });
      }
  ...
  render() {
    ...
    if (movie == null || loading) {
      ...
      if (movie.reviews.length > 0) hasReviews = true;
          ...
          <div className="col s7 mov">
            <h2 className="movieTitleDetail">
              ...
              <i
                ...
                className="small material-icons right favIcon fav"
              >
            ...
            <div className="row">
              <Link
                to={`/order/${movie.id}`}
                className="waves-effect waves-light btn-large movieButton"
              >
            ...
            <div className="col s12">
              <ul className="tabs">
                <li className="tab col s6">
                  <a className="active" href="#trailer">
                    Trailer
                  </a>
                </li>
                <li className="tab col s6">
            ...
            <div id="reviews" className="col s12">
              ...
              >
                <div className="input-field col s2">
                  ...
                  />
                  {errors.rating ? (
                    <span className="helper-text error"> {errors.rating} </span>
                  ) : null}
                ...
                <div className="input-field col s6">
                  ...
                  />
                  {errors.text ? (
                    <span className="helper-text error"> {errors.text} </span>
                  ) : null}
                  <label htmlFor="text">Text</label>
                </div>
                <div className="input-field col s4">
                  <button className="btn-large addReviewBtn">
                    {" "}
                    Add a Review <i className="material-icons">add</i>
                  </button>
                </div>
              </form>
            </div>
...
export default connect(
  mapStateToProps,
  { getMovies, getMovieById, favouriteMovie, unFavouriteMovie, addReview }
)(withRouter(Movie));
