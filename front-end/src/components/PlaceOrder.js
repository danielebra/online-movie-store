...
import { editUser, storeAnonymousUser, clearFeedback } from '../actions/authActions';
...
class  PlaceOrder extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.auth.isAuthenticated || nextProps.auth.anonymousUserAuthenticated) {
  ...
  makeOrder=() => {
    ...
    render(){
        const { shippingFee, totalPrice, user, errors, isAuthenticated } = this.state;
            ...
            <div className="col s7">
              ...
              <div className="row" style={{marginTop: 50}}>
               <span className="helper-text success"> { !isEmpty(feedback) ? feedback : null }</span>
                  ...
                  { isAuthenticated ? this.props.auth.user.shipping_address ? (
                      <div className="address">
                          <div className="prices">
                            <h6>Shipping Address: {this.props.auth.user.shipping_address}</h6>
                      ...
                      <form className="add-order" onSubmit={this.saveDetails}>
                        <h6 style={{marginLeft: '10px'}}> Please enter your address below </h6>
                        <div className="input-field col s12">
                          <input
                            ...
                            aria-required=""
                          />
                          <label id="addressLabel" htmlFor="shipping_address">Shipping address</label>
                      ...
                      <form className="add-order" onSubmit={this.saveDetails}>
                        <h6 style={{marginLeft: '10px'}}> Please fill in your details below </h6>
                        <div className="input-field col s12">
                          <input
                            type="text"
                            id="shipping_address"
                            ...
                            aria-required=""
                          />
                          <label id="addressLabel" htmlFor="shipping_address">Name</label>
...
export default connect(mapStateToProps, { getMovieById, addOrder, editUser, storeAnonymousUser, clearFeedback})(PlaceOrder);